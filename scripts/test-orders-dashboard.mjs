...
assert.ok(html.indexOf("CUSTOMER") < html.indexOf("ITEM"), "CUSTOMER precedes ITEM");
assert.ok(html.indexOf("ITEM") < html.indexOf("AMOUNT"), "ITEM precedes AMOUNT");
assert.ok(html.indexOf("AMOUNT") < html.indexOf("PROGRESS"), "AMOUNT precedes PROGRESS");
assert.ok(html.indexOf("PROGRESS") < html.indexOf("DUE"), "PROGRESS precedes DUE");
assert.ok(html.indexOf("DUE") < html.indexOf("ACTION"), "DUE precedes ACTION");
