...
try {
  ...
  assert.equal((await evaluate(cdp, `Boolean(document.querySelector(".staff-drawer")) && document.body.innerText.includes("NEW STAFF")`)), true, "Invite drawer did not open.");
