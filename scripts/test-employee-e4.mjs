...
assert.ok(main.includes("[\"owner\", \"admin\"].includes(adminUser?.role)") && !main.includes("[\"owner\", \"admin\", \"staff\"].includes(adminUser?.role);\n}"), "Staff must no longer have permanent Calendar UI access.");
