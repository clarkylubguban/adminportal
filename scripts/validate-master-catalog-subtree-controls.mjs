...
const checks = [
  ...
  ["Product Quick Control is preserved", main.includes("function renderCatalogProductQuickControl") && main.includes("catalog-quick-summary") && main.includes("Status / Visibility") && main.includes("Full Edit Product") && main.includes("catalog-quick-more") && main.includes("data-catalog-duplicate") && main.includes("data-catalog-archive-product") && main.includes("data-catalog-copy-sku")],
