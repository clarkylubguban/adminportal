...
const container = `trry-m0-validation-${Date.now()}`;
...
try {
  ...
  await psqlFile("/workspace/supabase/tests/master_catalog_m0_foundation.sql");
  console.log("Master Catalog M0 validation passed.");
} finally {
