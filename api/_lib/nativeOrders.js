...
export function normalizeOrder(row) {
  ...
  return {
    ...
    fulfillmentDetails: row.fulfillment_details && typeof row.fulfillment_details === "object" ? row.fulfillment_details : null,
    paymentState: cleanText(row.payment_state, 40),
    paymentReference: cleanText(row.payment_reference, 120),
    paidAt: cleanText(row.paid_at, 80),
    fulfillmentState: cleanText(row.fulfillment_state, 40),
    handedOverAt: cleanText(row.handed_over_at, 80),
    handoverKind: cleanText(row.handover_kind, 40),
    reservationExpiresAt: cleanText(row.reservation_expires_at, 80),
