-- Remove obsolete Odoo and payment gates from the Admin Portal workflow.
-- Forward correction only: preserves existing payment/Odoo fields and historical values.
